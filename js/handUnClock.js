...
(function() {
    ...
    HandUnclock.prototype.initDOM = function(){
        var wrap = document.createElement('div');
        wrap.setAttribute("id","container");
        var str = '<canvas id="gesture" width="'+this.option.width+'" height="'+this.option.height+'"></canvas>'+
                  '<div class="tips"><span>请输入手势密码</span></div><div class="operation">'+
                  '<input type="radio" id="setPwd" name="option" value="setPwd" checked><label for="setPwd">设置密码</label><br>'+
                  '<input type="radio" id="verifyPwd" name="option" value="verifyPwd"><label for="verifyPwd">验证密码</label></div>';
